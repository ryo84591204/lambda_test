...
if __name__ == "__main__":
    # usage_demo()
    # sqs = boto3.client("sqs", endpoint_url="http://queue:9324", region_name="default")
    # Create a SQS queue
    sqs = boto3.resource(
        "sqs",
        endpoint_url="http://queue:9324",
    ...
    response = sqs.create_queue(
        ...
        Attributes={"DelaySeconds": "5", "MessageRetentionPeriod": "86400"},
    )
